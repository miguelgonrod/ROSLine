"""
Provide the RosAgent class with the needed topics to map the LLM Request to the respective
command in terminal to execute the requests.
...
class RosAgent(Node):
    ...
    def list_topics(self) -> str:
        ...
        :rtype: str
        """
        cmd_str = f'source /opt/ros/{os.environ.get("ROS_DISTRO", "jazzy")}/setup.bash; ros2 topic list'
    ...
    def list_nodes(self) -> str:
        ...
        :rtype: str
        """
        cmd_str = f'source /opt/ros/{os.environ.get("ROS_DISTRO", "jazzy")}/setup.bash; ros2 node list'
    ...
    def list_services(self) -> str:
        ...
        :rtype: str
        """
        cmd_str = f'source /opt/ros/{os.environ.get("ROS_DISTRO", "jazzy")}/setup.bash; ros2 service list'
    ...
    def get_info(self, type: str, name: str) -> str:
        """
        Get the information of a ROS2 {topic, node, service}.
        
        :param type: type of object we need the information {topic, node, service}.
        :type type: str
        ...
        :rtype: str
        """
        cmd_str = f'source /opt/ros/{os.environ.get("ROS_DISTRO", "jazzy")}/setup.bash; ros2 {type} info {name}'
    ...
    def listener_callback(self, msg: String) -> None:
        """
        Returns the message captured by the topic (TODO). 
    ...
    def timer_callback(self) -> None:
        """
        Creates a timer callback for publishing or listening topics (TODO).
...
def main(args: Any = None) -> None:
    """
    Creates the main loop for the local agent, in case we don't need the LLM logic.
