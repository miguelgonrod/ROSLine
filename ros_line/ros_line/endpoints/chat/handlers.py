...
def resolve_cmd_vel_topic(ros_agent: RosAgent | None, robot_name: str, default_topic: str = "/cmd_vel") -> tuple[str, str]:
    """
...
def _build_twist_message(linear_x: float, linear_y: float, angular_z: float, linear_z: float = 0.0, angular_x: float = 0.0, angular_y: float = 0.0) -> dict:
    """
...
def handle_move_robot(request: ChatRequestDTO, llm: "ChatGoogleGenerativeAI | Any", user_input: str, movement_data: dict, append_message_fn=append_message) -> dict:
    """
    ...
    twist_message = _build_twist_message(linear_x, linear_y, angular_z, linear_z=linear_z, angular_x=angular_x, angular_y=angular_y)
    ...
    ros_command = (
        ...
        f'"{{linear: {{x: {linear_x}, y: {linear_y}, z: {linear_z}}}, angular: {{x: {angular_x}, y: {angular_y}, z: {angular_z}}}}}"'
    )
...
def handle_stop_robot(request: ChatRequestDTO, llm: "ChatGoogleGenerativeAI | Any", user_input: str, append_message_fn=append_message) -> dict:
    """
